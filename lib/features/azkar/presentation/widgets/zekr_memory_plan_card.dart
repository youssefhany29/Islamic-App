...
class ZekrMemoryPlanCard extends StatelessWidget {
  const ZekrMemoryPlanCard({
    super.key,
              ...
              child: Column(
                ...
                children: [
                  ...
                  _InfoPoint(
                    ...
                    text: 'تقرأ الذكر عادي بدون أي إجبار على الحفظ.',
                    color: theme.colorScheme.primary,
                  ),
                  ...
                  _InfoPoint(
                    ...
                    text:
                        'لو حبيت تحفظ، افتح "درّبني على الحفظ" واستخدم القراءة أو التدريب أو الاختبار.',
                    color: theme.colorScheme.primary,
                  ),
                  SizedBox(height: isLargeScreen ? 9 : 8.h),
                  _InfoPoint(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    width: double.infinity,
                    child: Text(
                      enabled ? 'خطة الحفظ مفعّلة' : 'تفعيل خطة الحفظ',
                      textAlign: TextAlign.right,
                      textDirection: TextDirection.rtl,
                      locale: const Locale('ar'),
                      maxLines: 2,
                  ...
                  SizedBox(
                    ...
                    child: Text(
                      enabled
                          ...
                          : 'اختيارية؛ فعّلها لو حابب تتابع حفظ الأذكار.',
                      textAlign: TextAlign.right,
                      textDirection: TextDirection.rtl,
                      locale: const Locale('ar'),
                      maxLines: 3,
