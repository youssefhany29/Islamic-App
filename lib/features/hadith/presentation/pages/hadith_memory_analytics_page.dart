...
import 'hadith_today_review_page.dart';

import 'package:islamic_app/core/typography/app_text_styles.dart';
part 'hadith_memory_analytics_widgets.dart';
part 'hadith_memory_analytics_overview_widgets.dart';
part 'hadith_memory_analytics_chart_widgets.dart';
part 'hadith_memory_analytics_list_widgets.dart';
...
class HadithMemoryAnalyticsPage extends StatefulWidget {
  const HadithMemoryAnalyticsPage({super.key});

  @override
  State<HadithMemoryAnalyticsPage> createState() =>
      _HadithMemoryAnalyticsPageState();
}

class _HadithMemoryAnalyticsPageState extends State<HadithMemoryAnalyticsPage> {
  final HadithMemoryProgressService _service =
      const HadithMemoryProgressService();
  late Future<HadithMemoryDashboardStats> _statsFuture;
      ...
      builder: (dialogContext) {
        ...
        return Directionality(
          ...
          child: AlertDialog(
            ...
            content: Text(
              'سيتم حذف محاولات الحفظ والتحليل ومواعيد المراجعة. لن يتم حذف الأحاديث نفسها.',
              textAlign: TextAlign.right,
              textDirection: TextDirection.rtl,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder<HadithMemoryDashboardStats>(
          future: _statsFuture,
          builder: (context, snapshot) {
            ...
            final stats = snapshot.data ?? HadithMemoryDashboardStats.empty();
