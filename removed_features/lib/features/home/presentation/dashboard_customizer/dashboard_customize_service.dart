...
class DashboardCustomizeService {
  ...
  Future<DashboardCustomizeState> load() async {
    ...
    final videoWideMap = _decodeVideoWideMap(
      prefs.getString(_videoSizeKey),
    );
  ...
  static bool _isHideable(String id) {
    return id != DashboardTileIds.worship &&
...
class WorshipTileIds {
  ...
  static const String nightPrayer = 'worship_night_prayer';
