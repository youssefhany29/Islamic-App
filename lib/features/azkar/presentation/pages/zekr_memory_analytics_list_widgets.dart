...
class _MemoryItemsCard extends StatelessWidget {
  ...
  final List<ZekrMemoryItemStateModel> items;
  final IconData icon;
  final Color color;
...
class _RecentAttemptsCard extends StatelessWidget {
  ...
  final List<ZekrMemoryAttemptModel> attempts;
...
class _AttemptTile extends StatelessWidget {
  ...
  final ZekrMemoryAttemptModel attempt;

  @override
  Widget build(BuildContext context) {
    final m = _AnalyticsMetrics.of(context);
    final theme = Theme.of(context);
    final color = attempt.rating == ZekrMemoryRating.mastered
        ? const Color(0xff21C58E)
        : attempt.rating == ZekrMemoryRating.partial
