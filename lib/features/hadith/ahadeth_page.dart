...
import 'package:islamic_app/features/hadith/presentation/adaptive/hadith_tablet_fold_layout.dart'
    as hadith_adaptive;
...
part 'ahadeth_page_widgets.dart';
part 'ahadeth_page_search_widgets.dart';
part 'ahadeth_page_entry_widgets.dart';
part 'ahadeth_page_large_widgets.dart';
...
class _AhadethpageState extends State<Ahadethpage> {
  ...
  List<_HadithSearchResult> _searchResultsFor(String query) {
    ...
    for (final category in HadithLocalData.categories) {
      ...
      for (final item in items) {
        ...
        results.add(
          _HadithSearchResult(category: category, item: item, score: score),
        );
      }
    }
  ...
  Future<void> _openTodayReview() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const HadithTodayReviewPage()),
    );
  ...
  Future<void> _openAnalytics() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const HadithMemoryAnalyticsPage()),
    );
  ...
  Future<void> _openApiBooks() async {
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const HadithApiBooksPage()),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final List<_HadithSearchResult> searchResults = isSearching
