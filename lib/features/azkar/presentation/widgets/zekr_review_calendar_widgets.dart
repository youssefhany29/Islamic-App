part of 'zekr_review_calendar_card.dart';
...
class _ReviewCalendarStrip extends StatelessWidget {
  ...
  final List<ZekrMemoryItemStateModel> states;
  final List<ZekrMemoryItemStateModel> selectedItems;
  ...
  Widget build(BuildContext context) {
    ...
    final bool large = _zekrCalendarLargeScreen(context);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Text(
              'راجع الأذكار التالية، وبعد الانتهاء قيّم حفظك من صفحة مراجعة اليوم.',
              textAlign: TextAlign.right,
              textDirection: TextDirection.rtl,
              locale: const Locale('ar'),
              style: AppTextStyles.caption(context).copyWith(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Text(
              isToday
                  ? 'تمام، لا يوجد عليك أي مراجعة اليوم. لو تدربت على ذكر جديد، هيظهر ميعاد مراجعته هنا.'
...
class _ReviewPreviewTile extends StatelessWidget {
  ...
  final ZekrMemoryItemStateModel item;
  final int index;
