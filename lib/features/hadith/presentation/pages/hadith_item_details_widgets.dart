part of 'hadith_item_details_page.dart';
...
class _HadithFullTextCard extends StatelessWidget {
  const _HadithFullTextCard({required this.item, required this.reference});
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final Widget completeButton = OutlinedButton(
                  ...
                  child: Text(
                    isCompleted ? 'إلغاء التمام' : 'تم الحديث',
                    textDirection: TextDirection.rtl,
