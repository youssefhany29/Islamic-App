...
const List<ZekrItemModel> _duas = [
  ZekrItemModel(
    id: "duas_1",
    categoryId: ZekrLocalData.duasId,
  ...
  ZekrItemModel(
    ...
    text: "رب اغفر لي وتب عليّ إنك أنت التواب الغفور (100 مرة قبل أن يقوم)",
    count: 100,
    type: ZekrType.general,
  ),
  ZekrItemModel(
    ...
    text: "كفارة المجلس",
    count: 1,
    benefit: "سبحانك اللهم وبحمدك ، أشهد أن لا إله إلا أنت أستغفرك وأتوب إليك",
    type: ZekrType.general,
  ),
  ZekrItemModel(
    id: "duas_20",
