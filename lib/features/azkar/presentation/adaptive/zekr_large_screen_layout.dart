...
class ZekrLargeScreenLayout extends StatelessWidget {
  const ZekrLargeScreenLayout({
    super.key,
...
class _ZekrLargeSidePanel extends StatelessWidget {
  const _ZekrLargeSidePanel({
    required this.memoryPlanLoading,
    required this.memoryPlanEnabled,
    required this.memoryPlanChanging,
    required this.reviewCalendarRefreshTick,
