...
const List<ZekrItemModel> _morningAzkar = [
  ZekrItemModel(
    id: "morning_1",
    categoryId: ZekrLocalData.morningId,
    title: "آية الكرسي",
    text:
  ...
  ZekrItemModel(
    id: "morning_8",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ إِنِّـي أَصْبَـحْتُ أُشْـهِدُك ، وَأُشْـهِدُ حَمَلَـةَ",
    text:
  ...
  ZekrItemModel(
    id: "morning_9",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ ما أَصْبَـَحَ بي مِـنْ نِعْـمَةٍ أَو بِأَحَـدٍ مِـنْ خ",
    text:
  ...
  ZekrItemModel(
    id: "morning_12",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ بِكَ أَصْـبَحْنا وَبِكَ أَمْسَـينا ، وَبِكَ نَحْـيا وَ",
    text:
  ...
  ZekrItemModel(
    id: "morning_14",
    categoryId: ZekrLocalData.morningId,
    title: "سُبْحـانَ اللهِ وَبِحَمْـدِهِ عَدَدَ خَلْـقِه ، وَرِضـا نَفْسِـه",
    text:
  ...
  ZekrItemModel(
    id: "morning_15",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ عافِـني في بَدَنـي ، اللّهُـمَّ عافِـني في سَمْـعي ، ا",
    text:
  ...
  ZekrItemModel(
    id: "morning_16",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ إِنّـي أَعـوذُ بِكَ مِنَ الْكُـفر ، وَالفَـقْر ، وَأَع",
    text:
  ...
  ZekrItemModel(
    id: "morning_17",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ إِنِّـي أسْـأَلُـكَ العَـفْوَ وَالعـافِـيةَ في الدُّنْ",
    text:
  ...
  ZekrItemModel(
    id: "morning_18",
    categoryId: ZekrLocalData.morningId,
    title: "يَا حَيُّ يَا قيُّومُ بِرَحْمَتِكَ أسْتَغِيثُ أصْلِحْ لِي شَأنِي",
    text:
  ...
  ZekrItemModel(
    id: "morning_20",
    categoryId: ZekrLocalData.morningId,
    title: "اللّهُـمَّ عالِـمَ الغَـيْبِ وَالشّـهادَةِ فاطِـرَ السّماواتِ وَا",
    text:
  ...
  ZekrItemModel(
    id: "morning_21",
    categoryId: ZekrLocalData.morningId,
    title: "أَعـوذُ بِكَلِمـاتِ اللّهِ التّـامّـاتِ مِنْ شَـرِّ ما خَلَـق",
  ...
  ZekrItemModel(
    id: "morning_23",
    categoryId: ZekrLocalData.morningId,
    title: "اللَّهُمَّ إِنَّا نَعُوذُ بِكَ مِنْ أَنْ نُشْرِكَ بِكَ شَيْئًا نَ",
    text:
  ...
  ZekrItemModel(
    id: "morning_24",
    categoryId: ZekrLocalData.morningId,
    title: "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنْ الْهَمِّ وَالْحَزَنِ، وَأَعُو",
    text:
  ...
  ZekrItemModel(
    id: "morning_25",
    categoryId: ZekrLocalData.morningId,
    title: "أسْتَغْفِرُ اللهَ العَظِيمَ الَّذِي لاَ إلَهَ إلاَّ هُوَ، الحَيُّ",
    text:
  ...
  ZekrItemModel(
    id: "morning_26",
    categoryId: ZekrLocalData.morningId,
    title: "يَا رَبِّ , لَكَ الْحَمْدُ كَمَا يَنْبَغِي لِجَلَالِ وَجْهِكَ , و",
    text:
  ...
  ZekrItemModel(
    id: "morning_27",
    categoryId: ZekrLocalData.morningId,
    title: "اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا",
    text:
  ...
  ZekrItemModel(
    id: "morning_29",
    categoryId: ZekrLocalData.morningId,
    title: "لَا إلَه إلّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَل",
    text:
