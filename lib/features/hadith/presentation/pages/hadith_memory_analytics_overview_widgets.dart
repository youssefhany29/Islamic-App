    ...
    return ListView(
      ...
      children: [
        ...
        _MemoryItemsCard(
          title: 'مراجعة اليوم',
          subtitle:
              'الأحاديث التي حان وقت مراجعتها فقط حسب خطة الحفظ المتباعد.',
          emptyText:
        ...
        _MemoryItemsCard(
          ...
          emptyText:
              'ابدأ بتقييم بعض الأحاديث من درّبني على حفظ الحديث، وبعدها هتظهر الأحاديث التي تحتاج تثبيت.',
        ...
        _MemoryItemsCard(
          title: 'أقوى الأحاديث',
          subtitle: 'أحاديث ثابتة عندك، حافظ عليها بالمراجعة المتباعدة.',
          emptyText:
              'اختار تمام بعد التدريب أكثر من مرة، وبعدها هتظهر هنا الأحاديث الثابتة.',
      ...
      child: Column(
        ...
        children: [
          _HeaderRow(
            ...
            subtitle: 'اقتراح مبني على المراجعات المستحقة وأضعف الأحاديث.',
          ),
