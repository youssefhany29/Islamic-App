...
class _PhoneZekrBody extends StatelessWidget {
  const _PhoneZekrBody({
...
class _ZekrSearchResultCard extends StatelessWidget {
  const _ZekrSearchResultCard({
    required this.result,
    required this.onTap,
    this.large = false,
  });

  final _ZekrSearchResult result;
...
class _ZekrSearchField extends StatelessWidget {
  const _ZekrSearchField({
