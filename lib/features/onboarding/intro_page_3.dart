...
class IntroPage3 extends StatelessWidget {
  ...
  const IntroPage3({super.key, required this.userName});
  ...
  Future<void> _completeIntroAndNavigate(BuildContext context) async {
    ...
    Navigator.pushAndRemoveUntil(
      context,
      NoAnimationPageRoute(page: const MainPage()),
      (route) => false,
    );
  }
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'التطبيق يساعدك تبني عادة ثابتة للصلاة، القرآن، الأذكار، والحفظ.',
                    textAlign: TextAlign.center,
                    textDirection: TextDirection.rtl,
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                              ...
                              children: const [
                                Expanded(
                                  child: _FeatureRow(
                                    ...
                                    title: 'تنظيم يومك',
                                    subtitle:
                                        'تابع الصلاة والورد اليومي بدون زحمة.',
                                  ),
                                ),
                                SizedBox(width: 14),
                                Expanded(
                                  child: _FeatureRow(
                                    ...
                                    title: 'تقدم واضح',
                                    subtitle:
                                        'اعرف إنجازك اليومي وأيامك المتتالية بسهولة.',
                                  ),
                                ),
                                SizedBox(width: 14),
                                Expanded(
