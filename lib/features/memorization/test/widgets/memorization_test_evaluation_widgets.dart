...
class _SelfEvaluationPanel extends StatelessWidget {
  ...
  final VoidCallback onExcellentTap;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (fullAyahText.trim().isNotEmpty &&
              fullAyahText.trim() != correctAnswerText.trim()) ...[
            SizedBox(height: 10.h),
            Text(
              'الآية أو المقطع كاملًا',
              textDirection: TextDirection.rtl,
              textAlign: TextAlign.right,
              style: AppTextStyles.caption(context).copyWith(
                fontWeight: FontWeight.w900,
          ...
          if (sourceLabel.trim().isNotEmpty) ...[
            ...
            Text(
              [
                sourceLabel,
                if (pageLabel.trim().isNotEmpty) pageLabel,
              ].join('\n'),
              textDirection: TextDirection.rtl,
              textAlign: TextAlign.right,
              softWrap: true,
