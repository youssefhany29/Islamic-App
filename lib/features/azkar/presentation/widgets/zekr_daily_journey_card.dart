...
class ZekrDailyJourneyCard extends StatelessWidget {
  const ZekrDailyJourneyCard({super.key});
        ...
        return FutureBuilder<_DailyJourneyData>(
          ...
          builder: (context, snapshot) {
            ...
            final String footerText = completed == total
                ? 'ما شاء الله، أتممت ورد الذكر اليوم'
                : 'ابدأ بخطوة صغيرة، ذكر واحد يكفي لتبدأ';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                width: double.infinity,
                                child: Text(
                                  'أنجزت $completed من $total أذكار أساسية اليوم',
                                  textAlign: TextAlign.right,
                                  textDirection: TextDirection.rtl,
                                  locale: const Locale('ar'),
                                  maxLines: 2,
