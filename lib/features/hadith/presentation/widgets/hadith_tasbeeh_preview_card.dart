...
class HadithTasbeehPreviewCard extends StatefulWidget {
  const HadithTasbeehPreviewCard({super.key});

  @override
  State<HadithTasbeehPreviewCard> createState() =>
      _HadithTasbeehPreviewCardState();
}

class _HadithTasbeehPreviewCardState extends State<HadithTasbeehPreviewCard> {
  int counter = 0;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: double.infinity,
                        child: Text(
                          'اقرأ حديثًا قصيرًا وراجعه بسرعة.',
                          textAlign: TextAlign.right,
                          textDirection: TextDirection.rtl,
                          locale: const Locale('ar'),
                          maxLines: 2,
