...
class HadithTabletFoldLayout extends StatelessWidget {
  const HadithTabletFoldLayout({
    super.key,
    ...
    return Directionality(
      ...
      child: ListView(
        ...
        children: [
            ...
            builder: (context, constraints) {
                ...
                return Column(
                  children: [
                    SizedBox(
                      ...
                      child: const HadithDailyJourneyCard(),
                    ),
                    SizedBox(height: gap),
                    SizedBox(
                      width: double.infinity,
                      ...
                      child: memoryPlanLoading
                          ...
                          : memory_plan.HadithMemoryPlanCard(
              ...
              return SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    const Expanded(child: HadithDailyJourneyCard()),
                    SizedBox(width: gap),
                    Expanded(
                      child: memoryPlanLoading
                          ? const _LargeLoadingCard()
          ...
          SizedBox(height: gap),
          SizedBox(
            height: topCardHeight * 0.82,
            child: _LargeActionCard(
              title: 'مكتبة الأحاديث',
              subtitle: 'تصفح كتب وأبواب الأحاديث.',
              icon: Icons.menu_book_rounded,
              onTap: onOpenApiBooks,
            ),
          ),
          ...
          return Column(
            children: [
              SizedBox(
                ...
                child: _LargeActionCard(
                  title: 'تحليل الحفظ',
                  subtitle: 'تابع الأحاديث المحفوظة واللي محتاجة مراجعة.',
