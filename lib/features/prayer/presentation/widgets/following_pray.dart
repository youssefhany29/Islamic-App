...
class _FollowingPrayState extends State<FollowingPray> {
  ...
  Future<void> _openAfterPrayerAzkar() async {
    final category = ZekrLocalData.getCategoryById(ZekrLocalData.afterPrayerId);

    await _openPage(ZekrReadingPage(category: category));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: widget.large ? 12 : 10.h),
        PrayerMotivationCard(large: widget.large),
      ],
    );
  }
}
