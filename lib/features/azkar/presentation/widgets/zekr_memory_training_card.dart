...
enum ZekrMemoryMode { read, train, test }

class ZekrMemoryTrainingCard extends StatefulWidget {
  const ZekrMemoryTrainingCard({
    super.key,
    required this.item,
    this.categoryId,
    this.categoryTitle,
  ...
  @override
  State<ZekrMemoryTrainingCard> createState() => _ZekrMemoryTrainingCardState();
}

class _ZekrMemoryTrainingCardState extends State<ZekrMemoryTrainingCard> {
  final ZekrMemoryProgressService _memoryProgressService =
      const ZekrMemoryProgressService();

  late bool _isExpanded;

  ZekrMemoryMode _mode = ZekrMemoryMode.read;
  bool _showAnswer = false;
  bool _isSavingRating = false;
  ZekrMemoryRating? _lastRating;
  ...
  void _changeMode(ZekrMemoryMode mode) {
    AppHaptics.tap(context);
  ...
  ZekrPracticeMode _practiceMode() {
    switch (_mode) {
      case ZekrMemoryMode.read:
        return ZekrPracticeMode.read;
      case ZekrMemoryMode.train:
        return ZekrPracticeMode.train;
      case ZekrMemoryMode.test:
        return ZekrPracticeMode.test;
    }
  }

  Future<void> _saveRating(ZekrMemoryRating rating) async {
    ...
    await _memoryProgressService.saveAttempt(
      ZekrMemoryAttemptModel(
        ...
        itemTitle: widget.item.title ?? 'ذكر',
  ...
  String _modeTitle() {
    switch (_mode) {
      case ZekrMemoryMode.read:
        return 'اقرأ الذكر كاملًا بهدوء';
      case ZekrMemoryMode.train:
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          _ModeButtonsContainer(
                            ...
                            mode: _mode,
                            onRead: () => _changeMode(ZekrMemoryMode.read),
                            onTrain: () => _changeMode(ZekrMemoryMode.train),
                            onTest: () => _changeMode(ZekrMemoryMode.test),
                          ),
                          ...
                          if (_canSaveRating) ...[
                            ...
                            _InlineRatingButtons(
                              ...
                              onMastered: () =>
                                  _saveRating(ZekrMemoryRating.mastered),
                              onPartial: () =>
                                  _saveRating(ZekrMemoryRating.partial),
                              onReview: () =>
                                  _saveRating(ZekrMemoryRating.review),
                            ),
                          ],
                        ],
                      )
      ...
      child: Row(
        ...
        children: [
          _ModeButton(
            ...
            selected: mode == ZekrMemoryMode.read,
            isLargeScreen: isLargeScreen,
            onTap: onRead,
          ),
          ...
          _ModeButton(
            ...
            selected: mode == ZekrMemoryMode.train,
            isLargeScreen: isLargeScreen,
            onTap: onTrain,
          ),
          SizedBox(width: isLargeScreen ? 7 : 6.w),
          _ModeButton(
            ...
            selected: mode == ZekrMemoryMode.test,
            isLargeScreen: isLargeScreen,
            onTap: onTest,
          ),
        ],
...
class _InlineRatingButtons extends StatelessWidget {
  ...
  final bool isLargeScreen;
  final bool isSaving;
  final ZekrMemoryRating? selectedRating;
      ...
      builder: (context, constraints) {
        ...
        final buttons = <Widget>[
          _RatingChipButton(
            ...
            selected: selectedRating == ZekrMemoryRating.mastered,
            enabled: !isSaving,
            isLargeScreen: isLargeScreen,
            onTap: onMastered,
          ),
          _RatingChipButton(
            ...
            selected: selectedRating == ZekrMemoryRating.partial,
            enabled: !isSaving,
            isLargeScreen: isLargeScreen,
            onTap: onPartial,
          ),
          _RatingChipButton(
            ...
            selected: selectedRating == ZekrMemoryRating.review,
            enabled: !isSaving,
            isLargeScreen: isLargeScreen,
            onTap: onReview,
          ),
