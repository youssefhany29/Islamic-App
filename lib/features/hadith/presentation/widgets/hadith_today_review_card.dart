...
class HadithTodayReviewCard extends StatelessWidget {
  const HadithTodayReviewCard({super.key, required this.onTap});

  final VoidCallback onTap;

  @override
  Widget build(BuildContext context) {
    const service = HadithMemoryProgressService();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          hasDue
                              ? 'عندك $dueCount أحاديث مستحقة اليوم، راجعهم باختبار سريع.'
