...
extension _PrayerTrackingDetailsLargeLayout on _PrayerTrackingDetailsPageState {
  Widget _buildPrayerTrackingDetailsLargeScaffold(BuildContext context) {
