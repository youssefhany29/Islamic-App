...
class AddCustomHadithPage extends StatefulWidget {
  const AddCustomHadithPage({super.key, this.itemToEdit});

  final HadithItemModel? itemToEdit;

  bool get isEditing => itemToEdit != null;

  @override
  State<AddCustomHadithPage> createState() => _AddCustomHadithPageState();
}

class _AddCustomHadithPageState extends State<AddCustomHadithPage> {
  ...
  Future<void> _save() async {
    ...
    final service = const HadithCustomStorageService();

    if (widget.isEditing) {
      await service.updateCustomHadith(
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        category: CustomAppBarCategory(
          text: widget.isEditing ? 'تعديل الحديث' : 'إضافة حديث',
        ),
      ),
      body: SafeArea(
        child: ListView(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: Text(
                                    widget.isEditing
                                        ? 'عدّل الحديث الخاص بك'
                                        : 'أضف حديث أو حديث خاص بك',
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    widget.isEditing
                                        ...
                                        : 'اكتب الحديث، وحدد عدد التكرار، وسيظهر في قسم أحاديثي الخاصة.',
                                    textAlign: TextAlign.right,
                                    textDirection: TextDirection.rtl,
                                    locale: const Locale('ar'),
                                    softWrap: true,
                      ...
                      _CustomTextField(
                        ...
                        label: 'نص الحديث',
                        hint: 'اكتب الحديث هنا',
                        maxLines: 5,
                        validator: (value) {
                          if (value == null || value.trim().isEmpty) {
                            return 'اكتب نص الحديث أولًا';
                          }
                      ...
                      _CustomTextField(
                        ...
                        hint: 'مثال: يريح القلب ويحديثني بالتوكل',
                        maxLines: 3,
                      ),
